<template>
    <social-sharing 
        url="https://hamaarbihar.live/covid-bihar/"
    ...
    >
        <div>
            ...
            <network network="linkedin" class="mx-4">
                <i class="fab fa-linkedin fa-2x"></i>
            </network>
            <network network="twitter" class="mx-4 blue--text">
                <i class="fab fa-twitter-square fa-2x"></i>
            </network>
            <network network="whatsapp" class="mx-4 green--text">
